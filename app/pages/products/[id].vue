  ...
  <div class="bg-white">
    ...
    <div v-else class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-8">
        <NuxtLink to="/" class="hover:text-accent-600 transition-colors"
          >Home</NuxtLink
        >
        <svg
          class="w-4 h-4"
        ...
        <NuxtLink to="/shop" class="hover:text-accent-600 transition-colors"
          >Shop</NuxtLink
        >
        <svg
          class="w-4 h-4"
        ...
        <div class="space-y-6">
          ...
          <div class="space-y-4">
            <button
              ...
              class="w-full bg-pink-700 text-white py-4 rounded-xl font-semibold hover:bg-pink-800 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
            >
              <svg
                v-if="!isAddingToCart"
                class="w-5 h-5"
            ...
            <div class="grid grid-cols-2 gap-4">
              <button
                class="w-full border border-gray-300 text-gray-700 py-3 rounded-xl font-medium hover:bg-gray-50 transition-colors duration-200"
              >
                <svg
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m9.032 4.026a9.001 9.001 0 01-7.432 0"
                  ></path>
                </svg>
                Share
              </button>
      ...
      <div class="mt-16">
        ...
        <div class="py-8">
          ...
          <div v-if="activeTab === 'reviews'" class="space-y-6">
            ...
            <!-- Write Review Button -->
            <button
              class="w-full md:w-auto px-6 py-3 border border-accent-600 text-accent-600 rounded-lg font-medium hover:bg-accent-50 transition-colors duration-200"
            >
              Write a Review
            </button>
          </div>
      ...
      <section v-if="relatedProducts.length > 0" class="mt-16">
        ...
        >
          <ProductsCard
            ...
            :is-favorite="
              favoriteStore.favorites.some((f) => f.id === relatedProduct.id)
            "
...
const discountPercentage = computed(() => {
  ...
  const discount =
    ((originalPrice - product.value.price) / originalPrice) * 100;
