...
const isFormValid = computed(() => {
  return name.value.length >= 2 && isValidEmail.value && isPasswordStrong.value && passwordsMatch.value;
});
  ...
  <div class="min-h-screen bg-gradient-to-br from-accent-50 via-white to-stone-50 flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-md">
      ...
      <div class="text-center mb-8 animate-fade-in-down">
        ...
        <p class="text-gray-600">Join Luxe and start shopping premium fashion</p>
      </div>
      ...
      <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-100 p-8 animate-scale-in-bounce">
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <input
                ...
                :class="{ 'border-red-500': password && !isPasswordStrong }"
                placeholder="••••••••"
              />
              <button
                type="button"
            ...
            <p v-if="password && !isPasswordStrong" class="text-sm text-red-600">
          ...
          >
            <div class="flex items-center">
              ...
              <p class="text-sm text-green-800">
                {{ store.getUser.name }} registered successfully! Redirecting...
              </p>
            </div>
          </div>
        ...
        <p class="mt-6 text-center text-sm text-gray-600">
          ...
          <NuxtLink to="/login" class="font-medium text-accent-600 hover:text-accent-700 transition-colors duration-300">
            Sign in here
          </NuxtLink>
        </p>
      </div>
