    ...
    <section class="bg-white border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex items-center justify-between">
          ...
          <NuxtLink
            to="/shop"
            class="flex items-center space-x-2 text-pink-700 hover:text-pink-800 font-medium"
          >
        ...
        <div v-if="isLoading" class="flex justify-center items-center py-20">
          <div class="text-center">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-accent-100 rounded-full mb-4">
              <svg class="animate-spin h-8 w-8 text-pink-700" fill="none" viewBox="0 0 24 24">
          ...
          <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-8">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div class="flex items-center space-x-4">
                <button class="text-pink-700 hover:text-pink-800 font-medium text-sm">
                  Add All to Cart
                </button>
                <button class="text-pink-700 hover:text-pink-800 font-medium text-sm">
                  Clear All
